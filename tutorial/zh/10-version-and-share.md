...
[第 11 章 —— *装上工程 skill 套件，给仓库立协议*](./11-setup-skills.md)。到这里你已经会写、会分享一个 skill 了。接下来的「进阶篇」换个目标：装一套现成的专业 skill，用它把 Claude Code 变成你的项目管理搭子 —— 从一句话想法一路走到一堆能让 agent 直接开工的 issue。
