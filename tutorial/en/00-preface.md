...
It now has several doors: you can run it in the **terminal** (the CLI), or use it inside the Claude desktop app. Behind both doors is the same agent, and both climb the three walls above. This book walks through the terminal door from start to finish — not because the desktop app doesn't work, but because Claude Code in the terminal is a **building block**, while the desktop app is a **terminus**. A terminus is handy, but you stop there; a building block can be built into other things. What this building block can eventually build, Parts 2 and 3 let you assemble for yourself — planning real work, then running it — and chapter 17 reflects on.
